...
namespace Instruction
{
    public enum Task { SET_MODE_STANDBY, SET_MODE_DICTATE, SET_DICTATE_BUTTON_RED, SET_DICTATE_BUTTON_GREEN,
        ...
        START_VOICE_RECOGNITION, SET_SEND_BUTTON_CLICKED, SET_SEND_BUTTON_UNCLICKED, START_TIMEOUT_COUNTER,
        STOP_TIMEOUT_COUNTER}

    public class Task_Sequence
    {
        /// <summary>
        /// Creates a list of various tasks. 
        /// Tasks are simply names that are intended to hold significance for the developer. 
        /// ex. Task {OPEN_DOOR, CLOSE_DOOR}
        /// </summary>
